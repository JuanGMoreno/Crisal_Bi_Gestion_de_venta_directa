...
function MetaRow({
  ...
  return (
    <div className="flex h-5 min-w-0 items-center gap-2 text-sm text-muted-foreground">
      <span className="shrink-0 text-sky-700 dark:text-sky-300">{icon}</span>
...
export function ClientCard({ client, onView, onEdit, onDelete }: ClientCardProps) {
  return (
    <article className="group flex h-full min-w-0 flex-col overflow-hidden rounded-[24px] border border-sky-100 bg-gradient-to-br from-sky-50 via-background to-blue-50 shadow-sm transition-transform duration-200 hover:-translate-y-1 hover:shadow-md dark:border-sky-900/40 dark:from-sky-950/20 dark:via-background dark:to-blue-950/20">
      <div className="flex h-40 shrink-0 items-center justify-between gap-4 border-b border-sky-100/80 p-5 dark:border-sky-900/40">
        <div className="flex min-w-0 items-center gap-4">
          <Avatar className="h-16 w-16 shrink-0 border-4 border-background shadow-sm ring-1 ring-sky-200 dark:ring-sky-900/70">
          ...
          <div className="min-w-0 space-y-2">
            <div className="h-[76px]">
              ...
              <p className="truncate text-sm text-muted-foreground">CC {client.cedula}</p>
            </div>
      ...
      <div className="flex flex-1 flex-col gap-3 p-5">
        ...
        <div className="mt-auto rounded-2xl border border-sky-100/80 bg-background/90 p-3 dark:border-sky-900/40">
